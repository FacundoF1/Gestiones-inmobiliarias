...
<header>
  ...
  <article class="login">
   	<a href="#" onClick="show_login();" id="login"> Iniciar sesión <span><img src="imagen/ecqlipse 2 - system white/POWER - STANDBY.png"></span></a>
    ...
    <article class="contact">
     <form action="<?php echo $loginFormAction; ?>" method="POST" name="Login">
      ...
      <tr>
      	<td><input type="email" title="*** Ingresa tu correo electronico ***" name="correo" placeholder=" Correo electronico " required="" >      </td>
      </tr>
      <tr>
      <td><label>Contraseña:</label></td>
      </tr>
      <td><input type="password" name="pass" title="*** Ingresa tu clave personal ***"  placeholder=" Clave personal " required=""></td>
      </tr>
      <tr>
...
<section class="centrado">
	<div>
    <h1>Bienvenido al Sistema Informático de Gestion</h1>
    <h3>Contamos con cinco secciones, que brindan información de los serviciós que ofrecemos</h3>
    </div>
    <div>
    <nav>
    <li><img src="imagen/ecqlipse 2 - system white/HOME.png"></li>
    <li><img src="imagen/ecqlipse 2 - system white/SYNCAPP.png"></li>
    <li><img src="imagen/ecqlipse 2 - system white/BOOK.png"></li>
    <li><img src="imagen/ecqlipse 2 - system white/INFO.png"></li>  
    <li><img src="imagen/ecqlipse 2 - system white/MAIL.png"></li>
    </nav>
    </div>           
</section>
</section>
