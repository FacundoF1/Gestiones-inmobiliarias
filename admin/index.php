...
<div id="content">
  <p id="pageName"><!-- InstanceBeginEditable name="Contenido" -->
  	<h1>Bienvenido <?php echo $row_usuario['NomUsu']; ?>, sección de administración...</h1><br />
    <br />
    <p><a href="../front/incio.php">Ir al inicio</a></p>
    <br />
    Seleccione una opci&oacute;n de la izquierda.
