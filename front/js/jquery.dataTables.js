...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Resultados 1 a 10 de 57 registros") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrada desde _MAX_ entradas totales)",
		 ...
		 * * `full_numbers` - 'Primero', 'Anterior', 'Proximo' and 'Ultimo' buttons, plus
		 *   page numbers
		 *  
